...
`assets/community-mirrors.ziggy` and opening a pull request with your changes. The diff should just add a single line to the end of the list:

```diff
 {
     [ "https://a.com",        "a",                  "a@a.com"      ],
     [ "https://b.com/zig",    "b",                  "b@b.com"      ],
+    [ "https://mymirror.com", "my-github-username", "my@email.com" ],
 }
```
